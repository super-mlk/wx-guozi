...
Page({
    ...
    switchNav(event) {
        ...
        wx.request({
            url: app.globalData.guoziBase + '/api/ydyl/fl',
            data: {},
            success: function(res) {
                flbh = res.data[cur].flbh;
                wx.request({
                    url: app.globalData.guoziBase + '/ydyl/List?flbh=' + flbh,
                    data: {
    ...
    getContent: function() {
        var that = this;
        wx.request({
            url: app.globalData.guoziBase + '/ydyl/list',
            data: {},
            success: function(res) {
                that.setData({
                    listArray: res.data,
